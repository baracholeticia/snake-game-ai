...
O objetivo é implementar, treinar e comparar diferentes agentes inteligentes atuando sobre o mesmo ambiente:

* um agente de **busca heurística**;
* um agente de **aprendizado por reforço**;
* um agente de **algoritmo genético**.
...
* ![Python](https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white) **Python** — modelagem do ambiente (regras, estado, recompensa) e dos agentes
...
# crie o ambiente virtual (só na primeira vez)
python -m venv venv
...
O backend estará disponível em [http://localhost:8000](http://localhost:8000), com o endpoint de jogo em `ws://localhost:8000/ws`.
